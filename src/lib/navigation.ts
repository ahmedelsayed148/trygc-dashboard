...
export const FEATURE_NAV_MAP: Record<string, NavItem | undefined> = {
  ...
  "live-ops": {
    ...
    to: "/live-ops",
    label: "Live Ops",
    description: "Monitor active users and live assigned work across the workspace.",
    icon: Radio,
  },
  widgets: {
    id: "widgets",
  ...
  "campaign-intake": undefined, // removed
  mistakes: {
    id: "mistakes",
    to: "/mistakes",
  ...
  "update-organizer": {
    id: "update-organizer",
    to: "/update-organizer",
    label: "Update & Handover Organizer",
    description: "Structure updates and compose detailed shift handovers in one elegant interface.",
    icon: Languages,
  },
...
export const NAV_SECTIONS = [
  { label: "Core", items: ["/", "/personal", "/community-team", "/live-ops", "/widgets"] },
