    ...
    return (
      <div className="p-8 flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <h2 className="text-2xl font-black text-zinc-800 dark:text-zinc-100 mb-2">Access Denied</h2>
          <p className="text-zinc-500">Only administrators can manage users.</p>
        </div>
      </div>
    );
  }
