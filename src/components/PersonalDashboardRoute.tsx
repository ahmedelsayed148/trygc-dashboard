...
export function PersonalDashboard() {
  ...
  const handleSaveEdit = () => {
    ...
    const isCommunityTask = Boolean(editFormData.campaignId?.startsWith('community-'));
    const isOperationalTask = Boolean(editFormData.campaignId && editFormData.teamId && !isCommunityTask);
          ...
          return {
            ...
            tasks: country.tasks.map((task: any) => {
              ...
              return {
                ...
                metricCON: editFormData.metricCON !== undefined ? editFormData.metricCON : task.metricCON,
                metricCOV: editFormData.metricCOV !== undefined ? editFormData.metricCOV : task.metricCOV,
                metricConfirmationToday: editFormData.metricConfirmationToday !== undefined ? editFormData.metricConfirmationToday : task.metricConfirmationToday,
                metricMissingDate: editFormData.metricMissingDate !== undefined ? editFormData.metricMissingDate : task.metricMissingDate,
                metricWithDate: editFormData.metricWithDate !== undefined ? editFormData.metricWithDate : task.metricWithDate,
                resultSummary: editFormData.resultSummary !== undefined ? editFormData.resultSummary : task.resultSummary,
                blocker: editFormData.blocker !== undefined ? editFormData.blocker : task.blocker,
