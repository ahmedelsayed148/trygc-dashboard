      ...
      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
        <div>
          ...
          <div className="flex items-center gap-3 mt-2 flex-wrap">
            <span className="flex items-center gap-1 text-xs text-emerald-500 font-bold"><CheckCircle2 className="w-3 h-3" />{statusCounts.onTrack} on track</span>
            <span className="flex items-center gap-1 text-xs text-amber-500 font-bold"><TrendingUp className="w-3 h-3" />{statusCounts.progress} in progress</span>
            <span className="flex items-center gap-1 text-xs text-rose-500 font-bold"><AlertTriangle className="w-3 h-3" />{statusCounts.behind} behind</span>
            {urgentCampaigns.length > 0 && <span className="flex items-center gap-1 text-xs text-orange-500 font-bold"><Clock className="w-3 h-3" />{urgentCampaigns.length} ending soon</span>}
            <span className="text-[10px] text-muted-foreground">Avg Cov: <span className="font-bold" style={{ color: covColor(avgCovPct) }}>{avgCovPct}%</span></span>
          </div>
        </div>
