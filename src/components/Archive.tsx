...
import { Archive as ArchiveIcon, Search, Filter, Calendar, CheckCircle2, Clock, RotateCcw, Trash2 } from 'lucide-react';
...
export function Archive() {
      ...
      <div className="flex items-center justify-center min-h-[60vh] p-8">
        <div className="text-center max-w-sm">
          <div className="w-16 h-16 rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center mx-auto mb-4">
            <ArchiveIcon className="w-7 h-7 text-zinc-400 dark:text-zinc-600" />
          </div>
  ...
  return (
    <div className="px-4 py-6 md:px-6 space-y-6 max-w-7xl mx-auto">
      ...
      <DateRangeFilter label="Archive Date Range" value={dateRange} onChange={setDateRange} />
...
function StatCard({ label, value, icon: Icon }: { label: string; value: any; icon: React.ElementType }) {
  return (
    <div className="bg-white dark:bg-zinc-950 rounded-3xl shadow-sm border border-zinc-200 dark:border-zinc-800 p-6">
      ...
      <div className="text-[11px] font-black text-zinc-400 uppercase tracking-widest mb-1">{label}</div>
