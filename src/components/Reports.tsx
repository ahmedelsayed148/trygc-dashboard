    ...
    return (
      <div className="p-8 max-w-3xl mx-auto">
        <motion.div
          ...
          className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-12 text-center"
        >
          ...
          <p className="text-zinc-500">Reports are only accessible to administrators.</p>
        </motion.div>
      </div>
    );
  }
