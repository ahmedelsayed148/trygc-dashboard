...
export function MemberViews() {
      ...
      <div className="flex items-center justify-center min-h-[60vh] p-8">
        <div className="text-center max-w-sm">
          <div className="w-16 h-16 rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 flex items-center justify-center mx-auto mb-4">
            <Eye className="w-7 h-7 text-zinc-400 dark:text-zinc-600" />
          </div>
  ...
  return (
    <div className="px-4 py-6 md:px-6 space-y-6 max-w-7xl mx-auto">
      <div>
        <h1 className="text-3xl font-black text-zinc-800 dark:text-zinc-100 mb-1">Member Views</h1>
        <p className="text-sm text-zinc-500 font-medium">View individual team member dashboards</p>
      </div>
